...
Notes
-----
- TOST implements the closed-form piecewise pdf in [1].
- TOIT implements the integral expression in [1] via vectorized trapezoidal integration.
- Defaults are reasonable examples; tune to your dataset or posterior estimates.
...
class InfectiousnessParams:
    ...
    .. [1] Hart WS, Maini PK, Thompson RN (2021).
           ...
           eLife, 10:e65534. https://doi.org/10.7554/eLife.65534
    """
    k_inc: float = 5.807
